...
/**
 * - Use explicit Function, Predicate, Supplier, Consumer (like Guava) - Higher
 * order functions - returning lambdas - Change Encrypter to class taking
 * Function<Byte, Byte>
 * - Turning Function, Supplier and Producer into lambda - Method references
 * (method, static method, constructor)
 */
public class J03_FunctionTest {
    ...
    public void shouldDecideIfNegative() {
        final Predicate<Double> isNegative = (Double t) -> t.intValue()<0;
    ...
    public void shouldCallOtherClassInConsumer() {
        ...
        final Consumer<Long> consumer = (Long t) -> dateMock.setTime(t);
    ...
    public void shouldCallOtherClassInPrimitiveConsumer() {
        ...
        final LongConsumer consumer = (long value) -> {
