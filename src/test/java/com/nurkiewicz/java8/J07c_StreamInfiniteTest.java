...
public class J07c_StreamInfiniteTest {
    ...
    public void shouldGenerateGrowingStrings() throws Exception {
        //given
        final Stream<String> starStream = Stream.iterate("", (String t) -> t + "*");
     ...
     *
     * @see
     * <a href="http://en.wikipedia.org/wiki/Approximations_of_π#Summing_a_circle.27s_area">Wikipedia</a>
     */
    @Test
    public void shouldEstimatePi() throws Exception {
        //given
        Stream<Point> randomPoints = Stream.iterate(new Point(0, 0), (Point t) -> Point.random());
//        int precision = 1_000;
