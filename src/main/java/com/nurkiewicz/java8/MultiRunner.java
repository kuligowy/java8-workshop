...
/**
 * Uses dirty static methods on purpose, so that it's easier to use during
 * testing.
 */
public class MultiRunner {
    ...
    /**
     * Runs blocks given number of times. Equivalent to replicating block number
     * of times into Iterable and passing to {@link #runMultiThreaded(Iterable)}
     *
     ...
     *
     * @param blocks Blocks of code to execute in a thread pool, each one only
     * once
     */
